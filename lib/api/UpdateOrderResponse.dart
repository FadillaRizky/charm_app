/// response : {"orderid":3,"so_number":"UCM2024070003","customer_name":"BERDIRI MATAHARI LOGISTIK, PT","pickup_dt":"2024-07-28","eta":"2024-07-30","actual_date_arrival":"2024-08-05","actual_time_arrival":"07:16:00","actual_date_loading":null,"actual_time_loading":null,"loading_checked":"0","actual_date_delivery":null,"actual_time_delivery":null,"actual_date_unloading":null,"actual_time_unloading":null,"armada_type":"TRONTON WINGBOX","commodity_name":"Others","origin":"Karawang","destination":"Lampung","vendor_name":"SINAR CAKRA BUANA, PT","police_number":"B 9317 TEZ","driver_name":"A FAQIH FADHOLI","driver_phone":"085692399503"}
/// level : "warehouse"
/// message : "success"
...
class UpdateOrderResponse {
  ...
  UpdateOrderResponse.fromJson(dynamic json) {
  ...
  String? _level;
  String? _message;
UpdateOrderResponse copyWith({  Response? response,
  String? level,
  String? message,
}) => UpdateOrderResponse(  response: response ?? _response,
  level: level ?? _level,
...
/// eta : "2024-07-30"
/// actual_date_arrival : "2024-08-05"
/// actual_time_arrival : "07:16:00"
...
class Response {
  Response({
      ...
      String? pickupDt, 
      String? eta, 
      String? actualDateArrival, 
      String? actualTimeArrival, 
  ...
  String? _pickupDt;
  String? _eta;
  String? _actualDateArrival;
  String? _actualTimeArrival;
...
Response copyWith({  num? orderid,
  ...
  String? get eta => _eta;
  String? get actualDateArrival => _actualDateArrival;
  String? get actualTimeArrival => _actualTimeArrival;
