...
class DailyUnloading extends StatefulWidget {
  @override
  State<DailyUnloading> createState() => _DailyUnloadingState();
}

class _DailyUnloadingState extends State<DailyUnloading> {
                                        ...
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (ctx) => DetailSO(
                                                    SoNumber:
                                                        order.soNumber!, OrderId: order.orderid!,status: "",)));
                                      },
                                      //   Navigator.of(
                                      //       context)
                                      //       .push(
